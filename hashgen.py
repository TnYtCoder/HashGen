...
HASHLANG = {
    ...
    '8': 'au90o', '9': 'auX0p',
    '@': 'au001Y', '#': 'au002Y', '$': 'au003Y', '%': 'au004Y',
    '^': 'au005Y', '&': 'au006Y', '*': 'au007Y', '(': 'au008Y',
    ')': 'au009Y', '-': 'au010Y', '_': 'au011Y', '=': 'au012Y',
    '+': 'au013Y', '[': 'au014Y', ']': 'au015Y', '{': 'au016Y',
    '}': 'au017Y', '|': 'au018Y', '\\': 'au019Y', ';': 'au020Y',
    ':': 'au021Y', '"': 'au022Y', '\'': 'au023Y', '<': 'au024Y',
    '>': 'au025Y', ',': 'au026Y', '.': 'au027Y', '/': 'au028Y',
    '?': 'au029Y', '!': 'au030Y', '`': 'au031Y', '~': 'au032Y'
